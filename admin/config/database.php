...
class database{
    ...
    public function insertCategory($title, $description){
        ...
        return $this->pdo->query($insert_category_query)->fetchAll();
    }

    # ======================== GET CATEGORIES =========================
    public function getCategories(){
        $get_categories_query = "SELECT* FROM categories";
        return $this->pdo->query($get_categories_query)->fetchAll();
    }

    # ======================== GET CATEGORY =========================
    public function getCategory($category_id){
        $category_id_query = "SELECT Title FROM categories WHERE Id=$category_id";
        return $this->pdo->query($category_id_query)->fetchAll()[0];
    }
    ...
    public function editCategory($category_id, $title, $description){
        ...
        return $this->pdo->query($edit_category_query);
   }
    ...
    # ======================== INSERT POST =========================
    public function insertPost($title, $description, $category, $thumbnail_name, $category_id, $user_id, $dateTime, $featured){
    ...
    public function getCategoryTitle($cat_id){
        $get_categoryTitle_query = "SELECT Title FROM categories WHERE Id='$cat_id'";
        return $this->pdo->query($get_categoryTitle_query)->fetchColumn();
    }
    ...
    public function updatePost($id, $title, $description, $featured, $category_id, $thumbnail_to_insert){
        $update_post_query = "UPDATE posts SET Title = '$title', Description='$description', Is_featured='$featured',Thumbnail='$thumbnail_to_insert', Category_id='$category_id' WHERE id=$id";
